import { FacetInfo } from '../types/protocol';

export const IDENTITY_CORE = {
  name: "Noorish Sabah, PAS",
  shortName: "Noorish Sabah",
...
export const FACETS_CONFIG: FacetInfo[] = [
  {
    id: 'officer',
    name: 'The State Strategist',
    tagline: '13-Year Constitutional Field Command',
    color: 'cyan',
    accentHex: '#00F0FF',
    frequencyHz: 528,
    description: 'Executive administration, public order, institutional justice, and systemic public service delivery across Punjab and Sindh.'
  },
  {
    id: 'economist',
    name: 'The Macro-Economist',
    tagline: 'Multilateral Quantitative Rigor',
    color: 'mint',
    accentHex: '#00FFA3',
    frequencyHz: 639,
  ...
  {
    id: 'ai-governor',
    name: 'The AI Policy Governor',
    tagline: 'Algorithmic Law & Sovereign Compute',
    color: 'violet',
    accentHex: '#8B5CF6',
    frequencyHz: 741,
    description: 'Human-centred artificial intelligence, algorithmic governance, sovereign intelligence agents, and ethical compute frameworks.'
  },
  {
    id: 'founder',
    name: 'The Venture Architect',
    tagline: 'Cellular Science & Cross-Border Scale',
    color: 'rose',
    accentHex: '#F43F5E',
    frequencyHz: 852,
    description: 'Architect of NOORIVA: halal ingestible beauty, cellular nutrition science, and cross-border commercial execution in Pakistan, UAE, UK, and North America.'
  },
  {
    id: 'convergence',
    name: 'The Unified Sovereign',
    tagline: 'Holistic Synthesis of Statecraft & Innovation',
    color: 'chrome',
    accentHex: '#F8FAFC',
    frequencyHz: 963,
    description: 'The holistic synthesis of state authority, academic precision, autonomous technology, and sovereign enterprise.'
  }
];
