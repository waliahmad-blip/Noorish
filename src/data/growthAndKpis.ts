import { LegacyKPI } from '../types/protocol';

export const GROWTH_MILESTONES = [
  { year: "2012", event: "Allocated to premier Pakistan Administrative Service (PAS) via nationwide CSS examination." },
  { year: "2014", event: "Graduated with distinction from Civil Services Academy (CSA) 40th CTP cohort." },
  { year: "2016", event: "Led emergency disaster readiness and high-altitude tourism governance in Rawalpindi & Murree." },
  { year: "2017", event: "Recovered PKR 1.4B in state land as Assistant Commissioner, Gujranwala City." },
  { year: "2018", event: "Stabilized provincial grain reserves and flour mill quotas as Deputy Director Food." },
  { year: "2019", event: "First woman Senior Director HRM at KMC Karachi, governing 7,000 personnel." },
  { year: "2020", event: "Directed planting of 1 Million trees and 45 Miyawaki forests as Director PHA Lahore." },
  { year: "2021", event: "Surpassed revenue targets by 118% and digitized land registries in Hafizabad." },
